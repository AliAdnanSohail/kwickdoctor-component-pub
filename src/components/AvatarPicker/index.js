    ...
    return (
      <div className="container">
        <div className="icon-trash">
          <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 21 21" fill="#ffffff" onClick={e => this.handleRemove(e)} >
        ...
        <label className="avatar-container" htmlFor={id} aria-label="Edit image">
          <input type="file" name={name} id={id} className="inputFile" ref={(input) => { this.fileUpload = input; }} onChange={e => this.handleUpload(e)} />
          <img className="user" alt="" src={avatar} />
        </label>
        <div className="icon-edit">
          <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 21 21" fill="#ffffff" onClick={e => this.handleUpload(e)} >
