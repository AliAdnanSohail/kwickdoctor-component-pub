    ...
    return (
      <div className="container">
        ...
        <div className="icon-trash">
          <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 21 21" fill="#ffffff" >
        ...
        <label className="avatar-container" htmlFor={id}>
