    ...
    return (
      <div className="container">
        <div className="icon-trash">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 19 19" fill="#ffffff" onClick={e => this.handleRemove(e)} >
        ...
        <div className="icon-edit">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 21 21" fill="#ffffff" htmlFor={id} onClick={e => this.handleEdit(e)} >
