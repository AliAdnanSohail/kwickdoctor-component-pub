...
var date = function date(value) {
  return (0, _moment2.default)(value, 'DD/MM/YYYY').isValid() && (0, _moment2.default)(value, 'DD/MM/YYYY').isBefore((0, _moment2.default)(), 'year') ? undefined : 'This doesn’t look like a valid date. Please check the date entered!';
};
