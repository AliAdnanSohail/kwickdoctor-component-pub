...
day.__hash = '4108471217';
day.__scoped = ['.day.jsx-3065497712{position:relative;width:100%;height:80px;padding:0;border:none;color:#4f5362;text-align:center;font-weight:600;line-height:80px;background:transparent;cursor:pointer;}', '.day.jsx-3065497712:focus{outline:none;}', '.day--selected.jsx-3065497712{padding:13px 0;line-height:54px;-webkit-transition:all 0.3s ease-in-out;transition:all 0.3s ease-in-out;}', '.day--selected.jsx-3065497712 .day__border.jsx-3065497712{max-width:100%;width:54px;height:54px;display:inline-block;color:#ffffff;background:' + _styleHelper2.default.primaryColor + ';border-radius:50%;}', '@media screen and (max-width:630px){.day--selected.jsx-3065497712 .day__border.jsx-3065497712{width:40px;height:40px;line-height:40px;}}', '.day--disabled.jsx-3065497712{font-weight:500;color:#bbbccd;cursor:default;}', '@media screen and (max-width:630px){.day.jsx-3065497712{padding:0;height:40px;line-height:40px;}}'];
day.__scopedHash = '3065497712';
