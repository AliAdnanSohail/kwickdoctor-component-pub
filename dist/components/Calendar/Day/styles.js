...
day.__hash = '2468175571';
day.__scoped = ['.day.jsx-1425202002{position:relative;width:100%;height:80px;padding:0;border:none;color:#4f5362;text-align:center;font-weight:600;line-height:80px;background:transparent;cursor:pointer;}', '.day.jsx-1425202002:focus{outline:none;}', '.day--selected--without-events.jsx-1425202002{padding:13px 0;line-height:54px;}', '.day--selected--without-events.jsx-1425202002 .day__border.jsx-1425202002{max-width:100%;width:54px;height:54px;display:inline-block;color:#ffffff;background:' + _styleHelper2.default.primaryColor + ';border-radius:100%;}', '@media all and (max-width:630px){.day--selected--without-events.jsx-1425202002 .day__border.jsx-1425202002{width:40px;height:40px;line-height:40px;}}', '.day--selected--with-events.jsx-1425202002{padding:13px 0;line-height:40px;}', '.day--selected--with-events.jsx-1425202002 .day__border.jsx-1425202002{max-width:100%;width:70px;height:40px;display:inline-block;color:#ffffff;background:' + _styleHelper2.default.primaryColor + ';border-radius:20px;}', '.day--disabled.jsx-1425202002{font-weight:500;color:#bbbccd;cursor:default;}', '@media all and (max-width:630px){.day.jsx-1425202002{padding:0 !important;height:40px;line-height:40px;}}'];
day.__scopedHash = '1425202002';
