...
navigation.__hash = '1326372955';
navigation.__scoped = ['.navigation.jsx-1167149914{margin-bottom:15px;position:relative;}', '.navigation__month.jsx-1167149914{text-align:center;font-weight:bold;font-size:1.1rem;padding-top:5px;}', '.navigation__month.jsx-1167149914 span.jsx-1167149914{display:inline-block;padding:0 7px;}', '.navigation.jsx-1167149914 button.jsx-1167149914{border:none;margin:0;padding:0;width:95px;background:transparent;outline:none;cursor:pointer;position:absolute;left:0;top:0;}', '.navigation.jsx-1167149914 button.next.jsx-1167149914{left:auto;right:0;}', '.navigation.jsx-1167149914 button.jsx-1167149914 svg.jsx-1167149914{width:14px !important;height:14px !important;}'];
navigation.__scopedHash = '1167149914';
var calendar = exports.calendar = ['.calendar{max-width:665px;color:' + _styleHelper2.default.textColor + ';}'];
calendar.__hash = '808225854';
calendar.__scoped = ['.calendar.jsx-1398186111{max-width:665px;color:' + _styleHelper2.default.textColor + ';}'];
calendar.__scopedHash = '1398186111';