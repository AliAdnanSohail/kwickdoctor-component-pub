      ...
      if (this.state.image == null) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'label',
            { htmlFor: id, 'aria-label': 'Edit image', className: 'jsx-' + _styles2.default.__scopedHash + ' ' + 'avatar-container'
            },
            _react2.default.createElement('input', { type: 'file', name: name, id: id, ref: function ref(input) {
                _this3.fileUpload = input;
              }, onChange: function onChange(e) {
                return _this3.handleUpload(e);
              }, className: 'jsx-' + _styles2.default.__scopedHash + ' ' + 'inputFile'
            }),
            _react2.default.createElement('img', { alt: '', src: this.state.image == null ? defaultImage : this.state.image, className: 'jsx-' + _styles2.default.__scopedHash + ' ' + 'upload-img'
            })
          ),
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            {
              className: 'jsx-' + _styles2.default.__scopedHash + ' ' + 'thumb'
            },
            _react2.default.createElement('img', { alt: '', src: this.state.image == null ? defaultImage : this.state.image, className: 'jsx-' + _styles2.default.__scopedHash + ' ' + 'thumb-img'
            })
          )
        ),
        _react2.default.createElement(
